...
<div>
    ...
    <x-button-orange wire:click="$dispatch('openCreateCustomerModal')"> <i class="mr-2 font-bold text-white cursor-pointer fa-solid fa-plus"></i>Yeni Müşteri</x-button-oran>
