<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link wire:navigate href="{{ route('states') }}" :active="request()->routeIs('states')">
                {{ __('İl') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('cities') }}" :active="request()->routeIs('cities')">
                {{ __('İlçe') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('districts') }}" :active="request()->routeIs('districts')">
                {{ __('Bölge') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('categories') }}" :active="request()->routeIs('categories')">
                {{ __('Kategori') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('types') }}" :active="request()->routeIs('types')">
                {{ __('Emlak Tpi') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link wire:navigate href="{{ route('customers') }}" :active="request()->routeIs('customers')">
                {{ __('Müşteri') }}
            </x-responsive-nav-link>
        </div>
